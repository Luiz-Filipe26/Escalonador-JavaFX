...
public class Escalonador extends Thread {
    ...
    private Escalonador(String _tipoEscalonador, int _numProcessadores, float _unidadeQuantum, int _quantumPorProcesso) {
    	...
    	this.tipoEscalonador = _tipoEscalonador;
    ...
    public void setFecharAoAcabar(boolean _fecharAoAcabar) {
        this.fecharAoAcabar = _fecharAoAcabar;
    }
    ...
    public static void atualizaListaDeProcessos(Processo p) {
        ...
        if (escalonador != null) {
        	EscalonadorController.getInstancia().repintarGrafico(escalonador.mapaDeInstantes, escalonador.instanteAtual);
...
//MÉTODO RUN =========================================================================
    ...
    public void run() {
        do {
            ...
            escalonadorController.mostrarResultadoEscalonador(numTrocasContexto, tempoMedioExecucao, tempoMedioEspera);
    ...
    private void mostrarStatusProcessos() {
        escalonadorController.atualizarGrafico(mapaDeInstantes, instanteAtual);
    }
    ...
    private void esperarUmQuantum() {
        instanteAtual++;
        escalonadorController.adicionarTexto("Instante atual: " + instanteAtual + "\n");
        try {
